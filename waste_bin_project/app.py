...
Admin: Vivek VM
This script generates a QR code and launches a web server with liquid glass aesthetics.
Users can login with a 6-digit password to earn points.
"""
...
def add_points():
    ...
    users_db[username]['points'] += points_to_add
    session['points'] = users_db[username]['points']
